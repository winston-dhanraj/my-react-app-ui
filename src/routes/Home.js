        ...
        <header className="Home-header">
          ...
          <div className="Home-details">
            ...
            <div className="Home-details-links">
              This is a sample application that shows how to integrate AWS Cognito with a React single-page application and how to use Cognito issued JWT access codes to secure backend Express based Node.js REST APIs.
            </div>
          </div>
        </header>
      </div>
